...
export function MyChatsSidebar({ children } : MyChatsSidebarProps){
    ...
    return (
        <div className={
            "w-full max-w-96 bg-white absolute top-0 left-0 bottom-0 md:static md:translate-x-0 transition-transform ease-linear " + 
        ...
        >
            <button
                ...
                className="flex md:hidden text-primary ml-auto mb-3 pr-1"
            >
